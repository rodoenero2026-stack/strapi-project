...
const Page = () => {
    ...
    const onCheckoutWhatsApp = () => {
        // 1. CONFIGURA AQUÍ TU NÚMERO (Código de país + número)
        // Ejemplo para México: 52 + 1 + 10 dígitos
            ...
            <div className="grid grid-cols-1 gap-x-12 lg:grid-cols-12">
                ...
                <div className="lg:col-span-7">
                    {items.length === 0 && (
                        <div className="p-10 border-2 border-dashed rounded-xl text-center">
                            <p className="text-gray-500">Tu carrito está vacío. ¡Ve a buscar tus labiales favoritos!</p>
                        </div>
                    )}
                ...
                <div className="p-6 rounded-xl bg-slate-50 lg:col-span-5 h-fit dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm">
                    ...
                    <p className="mt-4 text-xs text-center text-slate-500">
                        Al hacer clic, se abrirá un chat directo con nosotros para finalizar tu pedido.
                    </p>
                </div>
            </div>
        </div>
