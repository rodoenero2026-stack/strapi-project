        ...
        <div className="max-w-6xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 gap-x-12 lg:grid-cols-12">
                ...
                <div className="p-6 rounded-xl bg-slate-50 lg:col-span-5 h-fit dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm">
                    ...
                    <button 
                        className="w-full py-7 rounded-full !bg-[#25D366] hover:!bg-[#128C7E] !text-white font-bold text-lg flex items-center justify-center gap-3 transition-all transform active:scale-95 shadow-lg !border-none disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
